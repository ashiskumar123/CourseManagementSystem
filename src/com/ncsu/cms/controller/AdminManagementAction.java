...
public class AdminManagementAction extends ActionSupport {
	...
	public String execute() throws Exception{
		...
		//	cmsDB.insertStudent(291, "firstName", "lastName", "email", "address",1211, 1, 0 , 1, 1, "userName","pass",2);
			...
			course = cmsDB.getCourseList(courseId).get(0);
			cmsDB.insertPrerequisite(courseId, prereqType, prereqDetails);
			System.out.println("ACTION_SAVE_PREREQUISITE--->");
			System.out.println("courseId="+courseId);
			System.out.println("prereqType="+prereqType);
			System.out.println("prereqDetails="+prereqDetails);
		}
			...
			SimpleDateFormat sdc1=new SimpleDateFormat("h:mm a");
			SimpleDateFormat sdc2=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			
			fromTime = sdc2.format(sdc1.parse(fromTime));
			toTime = sdc2.format(sdc1.parse(toTime));
			
			System.out.println("From Time:" + fromTime);
			
			System.out.println(courseOfferingId+" "+ scheduleId+" "+schDay+" "+ fromTime+" "+ toTime);
			cmsDB.addSchedule(courseOfferingId, schDay, fromTime, toTime);
	...
	public String getPrereqDetails() {
		return prereqDetails;
	}
